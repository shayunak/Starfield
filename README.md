...
9. [cugraph-cu12](https://pypi.nvidia.com) (Install corresponding version to CUDA Toolkit: cu{$CUDA_VERSION}) **[if you want GPU Acceleration, and if you have resources]**
